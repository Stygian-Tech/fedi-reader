...
**Labeling rule:** Agent-discovered issues should use the `Agent` label in MCP calls. In Linear UI this may appear under the `Source` group. Also add the other relevant inferred labels and metadata from the current context.
